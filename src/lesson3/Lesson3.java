...
public class Lesson3 {
  ...
  static int[][] computeLevenshtein(List<String> wordList, boolean parallel) {
    ...
    IntStream stream = IntStream.of(indices);
    ...
    if (parallel) {
	 ...
	 stream.collect(() -> distances, (list, index) -> {
		    for (int j = 0; j < LIST_SIZE; j++) {
		    	if (j != index)
		    		list[index][j] = Levenshtein.lev(wordList.get(index), wordList.get(j));
		    }
	 }, (a, b) -> {
...
//    List<String> wordList = Arrays.asList("Strelitz", "stercorary", "rabble", "rheumily", "putrescible");
    
//    System.out.println(wordList);
    
    System.out.println("wordList.size()="+wordList.size());
    System.out.println("wordList[0]="+wordList.get(0));
    System.out.println("wordList.lastElement="+wordList.get(wordList.size()-1));
