...
public class Levenshtein {
  ...
  public static void main(String[] args) {
    System.out.println(lev("kitten", "sitting"));//3
    System.out.println(lev("flaw", "lawn"));//2
    System.out.println(lev("gumbo", "gambol"));//2
    System.out.println(lev("ROBERTMELANSON", "ROBERTOMELANSON"));//1
    System.out.println(lev("rabble", "rheumily"));
  }
}
